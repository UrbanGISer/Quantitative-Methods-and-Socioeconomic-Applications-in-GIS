/* Monocent.sas runs linear, nonlinear & weighted regressions for census tracts
...
proc import datafile="c:\QuantGIS_V2\Chicago_6Cnty\cnty6trtpt.dbf" dbms=dbf out=mono;

data mono; set mono;
  area_km2=Shape_Area/1000000; /*convert area unit to square-km */
  DIST=DIST_CBD;
  LnDIST=log(DIST); 
